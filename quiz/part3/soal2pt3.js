...
function perkalianUnik(arr) {
    ...
    let  mylittlesharkhasgoneforever = arr.reduce((accumulator,correntValue) => accumulator * correntValue,1)
    let indonesiagelap = arr.map(kelipatan => mylittlesharkhasgoneforever / kelipatan)

    return indonesiagelap
  }
