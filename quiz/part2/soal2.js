...
selanjutnya yang mengandung nilai angka palindrome. Contoh, jika angka adalah 27, maka function akan me-return nilai 33 karena angka 33 adalah angka palindrom. 
...
function angkaPalindrome(num){
    while(true){
        ...
        let dibalik = angka.split("").reverse().join("");
        if (angka === dibalik){
            return num;
        }
    }
